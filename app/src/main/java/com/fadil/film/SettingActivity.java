...
import com.fadil.film.service.DailyReminderMovie;
import com.fadil.film.service.UpComingTask;
...
public class SettingActivity extends AppCompatActivity {
    ...
    void setEnableDisableNotif(){
        dailySwitch.setChecked(appPreference.isDaily());

        upcomingSwitch.setChecked(appPreference.isUpcoming());
    }
